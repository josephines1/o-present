                                    ...
                                    <?php foreach ($data_jabatan as $jabatan) : ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a href="#" class="badge bg-danger" data-bs-toggle="modal" data-bs-target="#modal-danger-<?= $jabatan->id ?>">
                                                    Hapus
                                                </a>
                                            </td>
                                        </tr>
                                        ...
                                        <!-- Modal Box - Delete -->
                                        <div class="modal modal-blur fade" id="modal-danger-<?= $jabatan->id ?>" tabindex="-1" role="dialog" aria-hidden="true">
                                            <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body text-center py-4">
                                                        ...
                                                        <h3>Hapus?</h3>
                                                        <div class="text-muted">Apakah Anda yakin ingin menghapus jabatan <strong class="text-danger"><?= $jabatan->jabatan ?></strong>? Jabatan yang sudah dihapus tidak dapat dikembalikan.</div>
                                                    </div>
